...
// netlify/functions/marsPhotos.ts
var marsPhotos_exports = {};
__export(marsPhotos_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(marsPhotos_exports);
...
var handler = async (event) => {
  ...
  const { roverName, cameraName, apiKey } = event.queryStringParameters;
  if (!cameraName) {
...
mime-types/index.js:
   ...
   *)
*/
//# sourceMappingURL=marsPhotos.js.map
